...
return {
	legcomlvl3 = {
		...
		maxwaterdepth = 35,
		metalmake = 7, --2
		metalstorage = 750, --500
		mincloakdistance = 50,
		movementclass = "COMMANDERBOT",
		nochasecategory = "ALL",
		objectname = "Units/LEGCOMLVL3.s3o",
		pushresistant = true,
		radardistance = 1200, --900
		radaremitheight = 49,
		reclaimable = false,
   		releaseheld  = true,
		...
		showplayername = true,
		sightdistance = 700, --550
		sonardistance = 700, --550
		terraformspeed = 1500,
