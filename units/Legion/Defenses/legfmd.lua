	...
	legfmd = {
		...
		weapondefs = {
			fmd_rocket = {
				...
				coverage = 10000, --2000
				craterareaofeffect = 630, --420
				craterboost = 0,
				cratermult = 0,
				edgeeffectiveness = 0.15,
				energypershot = 22500, --7500
				...
				tolerance = 7000,
				tracks = true,
				turnrate = 120000, --10000
				weaponacceleration = 600, --150
				weapontimer = 2.5, --2.5
				weapontype = "StarburstLauncher",
				weaponvelocity = 12000, --6000
				damage = {
					default = 7500, --1500
				},
			},
