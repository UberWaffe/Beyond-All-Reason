return {
	leggate = {
		...
		customparams = {
			...
			shield_power = 16250, --3250
			shield_radius = 1100, --550
		...
		weapondefs = {
			repulsor = {
				...
				shield = {
					...
					energyupkeep = 0,
					force = 2.5,
					intercepttype = 11111, --1
					power = 16250, --3250
					powerregen = 312, --52
					powerregenenergy = 2812.5, --562.5
					radius = 1100, --550
					repulser = false, --true
					smart = true,
					startingpower = 2200, --1100
					visiblerepulse = true,
					badcolor = {
						[1] = 1,
						[2] = 0.2,
